(function () {
    ...
    angular.module('nectar_words_app')
      .service('Hub', function ($http, $q,$localStorage,
          ...
          {
              $localStorage.latest = newStat;
              if ($localStorage.nectarVisitedStats == null || $localStorage.nectarVisitedStats == undefined)
                  $localStorage.nectarVisitedStats = [];
              $localStorage.nectarVisitedStats.push(newStat);
          }
          this.getLatestStatistics = function () {
            ...
            if ($localStorage.latest != null && $localStorage.latest != undefined)
                latest = $localStorage.latest;
            return latest;
          }
          this.getAllStatistics = function () {
              var nectarVisitedStats = [];
              if ($localStorage.nectarVisitedStats != null && $localStorage.nectarVisitedStats != undefined)
                  nectarVisitedStats = $localStorage.nectarVisitedStats;
              return nectarVisitedStats;
          }
